...
class IngredienteController(Resource):
    def get(self, id):
        # filter_by > tenemos que indicar dentro de ese metodo las columnas que queremos usar para hacer el filtro
    ...
    def put(self, id):
        ...
        try:
            if ingrediente:
                ...
                # una vez vallidado la informacion a modificar, se procede a modificar los valores que se actualizaran
                ...
                return {
                    ...
                    'content': ingrediente_serializado
                }
            else:
                return {
                           'message': 'El ingrediente a actualizar no existe'
                       }, 404
        except ValidationError as e:
            return {
                       'message': 'La informacion es incorrecta',
