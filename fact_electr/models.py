...
class Comprobante(models.Model):
    ...
    tipo = models.CharField(
        choices=(['BOLETA', 'BOLETA'], ['FACTURA', 'FACTURA']), null=False, max_length=7)
...
class DetallePedido(models.Model):
    ...
    stockId = models.ForeignKey(
        to=Stock, related_name='detalle_pedidos', db_column='stock_id', on_delete=models.CASCADE)
    pedidoId = models.ForeignKey(
        to=Pedido, related_name='detalle_pedidos', db_column='pedido_id', on_delete=models.CASCADE)
