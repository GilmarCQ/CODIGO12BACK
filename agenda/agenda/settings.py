...
SECRET_KEY = 'django-insecure-tg%o@e5peboikk1ouz3p_duknim_$y2t4n0eq_8)gtsjsusrl_'
...
# sirve para el uso de plantillas, asi el navegador no intentara modificar traducir la pagina
LANGUAGE_CODE = 'es'
