...
def autenticador(username, password):
    """Funcion encargada de validar si las credenciales son correctas o no, si no son no pasara pero si si lo
    son retornara un JWT"""
...
def identificador(payload):
    """Sirve para validar a el usuario previamente autenticado"""
